...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assits/css/main.css?v=1">
    ...
    <script src="<?=base_url()?>assits/js/bootstrap-hijri-datetimepicker.js"></script>    
    ...
    <title>مرحبا بك في لوحة التحكم</title>
</head>
<body dir="rtl">    
    <div class="container-fluid">
        <div class="row">
            <div class="col-2">
                <div class="sidenav">
                <a href="<?=base_url().'home'?>">الرئيسية</a>
