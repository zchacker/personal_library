...
<form action="" method="post" class="row g-3" onsubmit="return onSubmit()">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" name="registery_number" value="<?=$book->registery_number?>" id="registery_number" placeholder="رقم السجل" required />
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">رقم الحفظ</label>
    <input type="text" class="form-control" name="save_number" id="save_number" value="<?=$book->save_number?>" placeholder="رقم الحفظ" required/>
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">الفن الأصلي</label>
    <input type="text" class="form-control" name="org_art" id="org_art" value="<?=$book->org_art?>" placeholder="الفن الأصلي" required />
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">الفن الفرعي</label>
    <input type="text" class="form-control" name="branch_art" id="branch_art" value="<?=$book->branch_art?>" placeholder="الفن الفرعي" required />
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">العنوان الأصلي</label>
    <input type="text" class="form-control" name="org_title" id="org_title" value="<?=$book->org_title?>" autocomplete="off" placeholder="العنوان الأصلي" required />
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">العنوان الفرعي</label>
    <input type="text" class="form-control" name="branch_title" id="branch_title" value="<?=$book->branch_title?>" autocomplete="off" placeholder="العنوان الفرعي" required/>
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">اسم المؤلف</label>
    <input type="text" class="form-control" name="auther_name" value="<?=$book->auther_name?>" autocomplete="off" placeholder="اسم المؤلف" required/>
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" name="book_start" id="book_start" value="<?=$book->book_start?>" autocomplete="off" placeholder="بداية المخطوط" required/>
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">نهاية المخطوط</label>
    <input type="text" class="form-control" name="book_end" id="book_end" value="<?=$book->book_end?>" autocomplete="off" placeholder="نهاية المخطوط" required/>
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">عدد الأوراق</label>
    <input type="number" class="form-control" name="pages_number" id="pages_number" value="<?=$book->pages_number?>" autocomplete="off" placeholder="عدد الأوراق" required/>
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" name="copy_name" id="copy_name" value="<?=$book->copy_name?>" autocomplete="off" placeholder="اسم الناسخ" required/>
  </div>
  <div class="col-md-4">
    <label for="inputEmail4" class="form-label">مكان النسخ</label>
    <input type="text" class="form-control" name="copy_location" id="copy_location" value="<?=$book->copy_location?>" autocomplete="off" placeholder="مكان النسخ" required/>
  </div>
  <div class="col-md-4">
